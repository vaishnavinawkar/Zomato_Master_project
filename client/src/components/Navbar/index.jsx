            ...
            <div className='gap-4 w-full items-center justify-around lg:flex'>
                ...
                <div className='w-3/4 bg-white shadow-md p-3 flex items-center gap-3 border border-gray-200 rounded '>
                    <div className='flex items-center gap-2 border-r-2 border-gray-300 pr-2'>
                        ...
                        <input 
                        type='text'
                        placeholder='Delhi NCR' className='focus:outline-none'/>
                        <IoMdArrowDropdown  />
                    </div>
                ...
                {user?.fullName ? (
                    <div className='relative w-20'>
                        <div onClick={() => setIsDropDownOpen((prev) => !prev)} className='border p-2 border-gray-300 text-zomato-400w-full h-20 rounded-full'>
                            <img 
...
function Navbar() {
    return (
        <>
         <nav className='p-4 flex bg-whie shadow-md lg:shadow-none w-full items-center'>
             <MobileNav/>
             <LargeNav/>
